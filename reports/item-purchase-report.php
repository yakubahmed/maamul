...
<?php $title = "Item Purchase report"; include(ROOT_PATH . '/inc/header.php'); ?>

      <?php $menu = 'Warbixin'  ?>
      
      <?php $smenu = 'Item purchase report'  ?>
  <body>
    <!-- .app -->
    <div class="app">
      <!-- [if lt IE 10]>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"> Item purchase <small>report</small> </h1>
                </div>
                      ...
                      <div class="card-body ">
                        ...
                        <form class='row' method='post' id='frmShowRep'>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id='bss4'  name = 'item' data-toggle='selectpicker' data-live-search='true' data-width='100%' >
                        ...
                        <div class="invoice-print" id='contentToPrint'>
                            ...
                            <div class="invoice-content">
                               <h4 class='text-center'>Item purchase report <small id='sr_fr_to'></small> </h4>
                               <hr>
...
$(document).ready(function(){
  ...
  $('#frmShowRep').on('submit', function(e){
    ...
    $.ajax({
      url:'../jquery/item-purchase-report.php', 
      type:'post', 
