...
<?php $title = "Purchase report"; include(ROOT_PATH . '/inc/header.php'); ?>
      <?php $menu = 'Warbixin'  ?>
      
      <?php $smenu = 'Purchase report'  ?>
  <body>
    <!-- .app -->
    <div class="app">
      <!-- [if lt IE 10]>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"> Purchase <small>report</small> </h1>
                </div>
...
$(document).ready(function(){
  ...
  $('#frmShowRep').on('submit', function(e){
    ...
    console.log(id)
    $.ajax({
      url:'../jquery/purchase-report.php', 
      type:'post', 
