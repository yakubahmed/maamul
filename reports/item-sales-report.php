...
<?php $title = "Item Sales report"; include(ROOT_PATH . '/inc/header.php'); ?>

      <?php $menu = 'Warbixin'  ?>
      
      <?php $smenu = 'Item sales report'  ?>
  <body>
    <!-- .app -->
    <div class="app">
      <!-- [if lt IE 10]>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"> Item sales <small>report</small> </h1>
                </div>
                      ...
                      <div class="card-body ">
                        ...
                        <div class="invoice-print" id='contentToPrint'>
                            ...
                            <div class="invoice-content">
                                   <h4 class='text-center'>Item sales report <small id='sr_fr_to'></small> </h4>
                                   <hr>
...
$(document).ready(function(){
  ...
  $('#frmShowRep').on('submit', function(e){
    ...
    $.ajax({
      url:'../jquery/item-sales-report.php', 
      type:'post', 
