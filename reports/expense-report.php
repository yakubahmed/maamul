...
<?php $title = "Expense report"; include(ROOT_PATH . '/inc/header.php'); ?>

      <?php $menu = 'Warbixin'  ?>
      
      <?php $smenu = 'Expense report'  ?>
  <body>
    <!-- .app -->
    <div class="app">
      <!-- [if lt IE 10]>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"> Expense <small>report</small> </h1>
                </div>
                      ...
                      <div class="card-body ">
                        ...
                        <form class='row' method='post' id='frmShowRep'>
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id='bss4'  name = 'exp_t' data-toggle='selectpicker' data-live-search='true' data-width='100%' >
                                <option data-tokens='' value=''> ALL  </option>
                                <?php 
                                    $stmt = "SELECT * FROM expense_type ORDER BY name ASC";
                        ...
                        <div class="invoice-print" id='contentToPrint'>
                            ...
                            <div class="invoice-content">
                               <h4 class='text-center'>Expense Report <small id='sr_fr_to'></small> </h4>
                               <hr>
                                   ...
                                   <table class="table table-striped ">
                                       <thead>
                                           <tr class='bg-success text-light'>
                                               ...
                                               <th style='min-width:140px;'>For</th>
                                               <th style='min-width:200;'>Description</th>
                                               <th style='min-width:160;'>Date</th>
                                               <th style='min-width:150;'>Account</th>
                                               <th>Amount</th>
