...
<?php $title = "Account Balance Report"; include(ROOT_PATH . '/inc/header.php'); ?>
<?php $menu = 'Warbixin'  ?>
<?php $smenu = 'Account Balance Report'  ?>
<body>
    <!-- .app -->
    <div class="app">
      <!-- .app-header -->
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"> Account Balance <small>report</small> </h1>
                </div>
                ...
                <div class="section-block">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div id="report_place">
                                <p class="text-center text-muted">Select date range and click "Show Report" to view account balances</p>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function(){
    ...
    $('#btnShowRep').on('click', function(e){
        ...
        $.ajax({
            url: '../jquery/reports/account-balance-report.php',
            type: 'post',
            data: {
                show_report: true,
                fdate: fdate,
