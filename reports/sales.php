...
<?php $title = "Sales report"; include(ROOT_PATH . '/inc/header.php'); ?>
      <?php $menu = 'Warbixin'  ?>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <div class="page-inner">
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"> Sales <small>report</small> </h1>
                </div>
                      ...
                      <div class="card-body ">
                        ...
                        <div class="invoice-print" id='contentToPrint'>
                            ...
                            <div class="invoice-content">
                               <h4 class='text-center'>Sales Report <small id='sr_fr_to'></small> </h4>
                               <hr>
