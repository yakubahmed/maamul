...
<?php $title = "Edit purchase"; include(ROOT_PATH . '/inc/header.php'); ?>
      <?php $menu = 'Purchase'  ?>
        ...
        <div class="wrapper">
          ...
          <div class="page">
            ...
            <?php if(isset($_GET['id'])){ ?>
              ...
              <div class="row">
                <div class="col-md-6">
                  <h1 class="page-title"><a href="<?= BASE_URL ?>purchase/history" class="btn "> <i class="fa fa-arrow-left"></i> </a> Edit purchase </h1>
                </div>
                      ...
                      <div class="card-body ">
                        ...
                        <form class='row' method='post' id='frmAddCust'>
                          ...
                          <div class='form-group col-md-6'>
                            ...
                            <div class="input-group input-group-alt">
                              <select name="customer" id="bss3" class="form-control customer" data-toggle='selectpicker' required data-live-search='true' >                                
                                <?php
                                  $cid = $_GET['id'];
                                  $stmt = "SELECT * FROM supplier WHERE supp_id in (SELECT supp_id FROM purchase WHERE purchase_id = $cid) LIMIT 1";
                                  $result = mysqli_query($con, $stmt);
                                  ...
                                  $stmt = "SELECT * FROM supplier WHERE  supp_id NOT IN (SELECT supp_id FROM purchase WHERE purchase_id = $cid)";
                                  $result = mysqli_query($con, $stmt);
                                  while($row = mysqli_fetch_assoc($result)){
                                    $id = $row['supp_id'];
                                    $name = $row['sup_name'];
                          ...
                          <div class='form-group col-md-3'>
                            ...
                            <?php 
                              $id = $_GET['id'];
                              $stmt = "SELECT pur_date FROM purchase WHERE purchase_id = $id";
                              $result = mysqli_query($con, $stmt); 
                              if($row = mysqli_fetch_assoc($result)){
                                $date = date("Y-m-d", strtotime($row['pur_date']))  ;
                                echo "
                          ...
                          <div class="form-group col-md-3">
                            ...
                            <select name="status" id="status" class="form-control">
                              <?php 
                                $id = $_GET['id'];
                                $stmt = "SELECT pur_status FROM purchase WHERE purchase_id = $id";
                                $result = mysqli_query($con, $stmt); 
                                while($row = mysqli_fetch_assoc($result)){
                                  $status = $row['pur_status'];
                                  if($status == "Ordered"){
                                    $status = "
                          ...
                          <div class="alert alert-info col-md-12">
                            <strong>Note:</strong> The items below are from the original purchase and cannot be modified. You can only update payment information and discount.
                          </div>
                          ...
                          <table class='table table-bordered table-hover table-responsive my-3'>
                              ...
                              <tbody id='order_list'>
                                  <?php 
                                    $id = $_GET['id'];
                                      ...
                                      $stmt .= " FROM item, pur_items WHERE item.item_id = pur_items.item_id AND pur_items.purchase_id = $id ";
                                      $result = mysqli_query($con, $stmt );
                              ...
                              <tfoot>
                                  <tr class='bg-info text-light'>
                                      ...
                                      <td class=''>   <strong id='totalamount'>0.00 $ </strong> </td>
                                  </tr>
                              </tfoot>
                            </table>
                        </form>
                          ...
                          <div class="form-group col-md-4">
                            ...
                            <div class="input-group input-group-alt">
                              ...
                              function getAmount(){
                                global $con;
                                $id = $_GET['id'];
                                $stmt = "SELECT * FROM purchase WHERE purchase_id = $id";
                                $result = mysqli_query($con, $stmt);
                                if($row = mysqli_fetch_assoc($result)){
...
$(document).ready(function(){
  ...
  // Items are read-only on edit purchase page
  // Item search and add functionality has been removed

  // All item modification functions removed (qty, delete, +/-, discount on item)
  // Items are read-only on edit purchase page
                          ...
                          $.ajax({
                              ...
                              success:function(res){
                                  ...
                                  if(res == "success"){
                                    ...
                                    toastr.error("Failed to update purchase: " + res)
                                  }
                              },
