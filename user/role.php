...
<?php $title = "Role"; include(ROOT_PATH . '/inc/header.php'); ?>
  <body>
    <!-- .app -->
    <div class="app">
      <!-- [if lt IE 10]>
                        ...
                        <div class="card-body ">
                          ...
                          <form class='row' method='post' id='frmAddRole'>
                            ...
                            <div class='form-group col-md-12'>
                              ...
                              <input type='text' name='rname' id='rname' minlength='5' class='form-control rounded-0' autocomplete="off" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                              <button type="submit" class="btn btn-info"> <i class="fa fa-plus"></i> Save role</button>
                            </div>
                                    ...
                                    <td>
                                      <div class='dropdown d-inline-block'>
                                        ...
                                        <div class='dropdown-menu dropdown-menu-right' style=''>
                                          ...
                                          <button type='button' id='edit_role' data-id='$id' class='dropdown-item'> <i class='fa fa-edit'></i> Edit Role</button>
                                          <button type='button' class='dropdown-item btn-danger' id='del_role' data-id='$id'><i class='fa fa-trash'></i> Delete Role</button>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
  ...
  $('#frmAddRole').on('submit', function(e){
    ...
    $.ajax({
      ...
      success: function(res){
        if(res == 'found_role'){
          toastr.error("This role is allready registered, try another one.")
          $('.overlay').addClass('d-none')
          $('#rname').addClass('is-invalid')
        }else if (res == 'success'){
          toastr.success("Role registered successfully")
          $('#frmAddRole')[0].reset();
          $('.overlay').addClass('d-none')
          ...
          success: function(data){
            if(data == 'success'){
              ...
              toastr.success("Updated Successfully")
                location.reload()
            }else if(data == "found_role"){
              toastr.error("The role that you entered is allready registered please another again")
              $('#rname').addClass('is-invalid')
